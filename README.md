...
## 心得
TDRI 推動此專案的初衷很好，但當日網站操作免費帳戶額度一下就沒了，幾乎不太能用，並且這些網站工具仍然有 bug，難道還沒和外包廠商完整驗收完？

考慮到操作上仍有一些問題，所以當日只能算先讓大家了解目前 TDRI 正在推動的產品分享活動。但同時也讓人擔憂，TDRI 沒有自己研發團隊，難道未來遇到什麼 bug 都要等待外包廠商修復？

最後是對開發成本和商業模式的疑慮，UX 研究是「相對」小眾的領域，台灣的市場太小很難撐起研究工具的商業模式，如果此專案不打算出海，那最終只會淪為燒錢的專案。台灣仍有許多與大眾直接相關的設計、服務體驗議題可以被 TDRI 改善，希望 TDRI 不要讓它最後淪為履歷驅動導向的專案。
